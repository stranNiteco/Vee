...
var symbolicNames = [ null, "LBracket", "RBracket", "LBrace", "RBrace", 
                      ...
                      "RPipe", "Dot", "Combine", "Compose", "AndAlso", "OrElse", 
                      "Not", "TypeOf", "Let", "In", "If", "Is", "When", 
                      "Then", "Else", "True", "False", "New", "As", "Type", 
                      "StringType", "NumberType", "BooleanType", "EnumType", 
                      "TupleType", "RecordType", "ListType", "MapType", 
                      "TaskType", "OptionType", "UnitType", "Number", "Name", 
                      "OpenTypeParam", "String", "WS" ];
...
FunctionCombinationContext.prototype.Compose = function() {
    return this.getToken(VeeParser.Compose, 0);
};
        ...
        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
            if(_alt===1) {
                ...
                case 8:
                    ...
                    this.state = 239;
                    localctx.op = this.match(VeeParser.Compose);
                    this.state = 240;
...
BinaryOperatorsContext.prototype.Compose = function() {
    return this.getToken(VeeParser.Compose, 0);
};
...
VeeParser.prototype.binaryOperators = function() {
    ...
    try {
        ...
        this.state = 536;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VeeParser.Pow) | (1 << VeeParser.Multiply) | (1 << VeeParser.Divide) | (1 << VeeParser.Modulo) | (1 << VeeParser.Plus) | (1 << VeeParser.Minus) | (1 << VeeParser.Eq) | (1 << VeeParser.Neq) | (1 << VeeParser.Lt) | (1 << VeeParser.Gt) | (1 << VeeParser.Lte) | (1 << VeeParser.Gte) | (1 << VeeParser.Combine) | (1 << VeeParser.Compose) | (1 << VeeParser.AndAlso) | (1 << VeeParser.OrElse))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
